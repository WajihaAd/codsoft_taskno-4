...
def start(name):
    ...
    global c
    print(f"\t\t\t\t\t\t\t\t\t\t\t\t\tWON:{count}")
    tt = ('Paper', 'Scissors', 'Rock')
    a1 = random.choice(tt)
    # print(a1)
    c=a1
    print("Enter your choice:"+f"<{tt[0]}>\t"   f"<{tt[1]}>\t"   f"<{tt[2]}>")
    guess1 = input("") 
    if a1 == "Rock" and guess1.capitalize() == "Paper":
        winning(name)
    elif guess1.lower()=="m":
        main1()
    elif guess1.lower()=="v":
      view()
        ...
        start(name)
    elif a1 == "Paper" and guess1.capitalize() == "Rock":
        losing(name)
    elif a1 == "Scissors" and guess1.capitalize() == "Paper":
        losing(name)
    elif a1 == "Rock" and guess1.capitalize() == "Scissors":
        losing(name)
    elif a1 == "Paper" and guess1.capitalize() == "Scissors":
        winning(name)
    elif a1 == "Scissors" and guess1.capitalize() == "Rock":
        winning(name)
    else:
        raise ValueError("INVALID INPUT")
